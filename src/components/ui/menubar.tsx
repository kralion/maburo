...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      "flex flex-col text-zinc-600  gap-5 w-36 items-center space-x-1 rounded-md   p-1  dark:bg-slate-950",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex gap-3  w-full hover:text-green-500 group cursor-pointer select-none  items-center rounded-lg px-3 py-2 text-sm font-medium outline-none focus:bg-slate-100 focus:text-slate-900 data-[state=open]:bg-slate-100 data-[state=open]:text-slate-900 dark:focus:bg-slate-800 dark:focus:text-slate-50 dark:data-[state=open]:bg-slate-800 dark:data-[state=open]:text-slate-50",
      className
    )}
    {...props}
  />
